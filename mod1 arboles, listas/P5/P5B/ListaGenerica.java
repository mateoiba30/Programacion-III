...
public abstract class ListaGenerica<Tipo> {
	 ...
	 */
	public abstract Tipo elemento(int pos);
	 ...
	 * */
	public abstract boolean agregarEn(Tipo elem, int pos);
	 ...
	 *            elemento a agregar
	 * */
	public abstract boolean agregarInicio(Tipo elem);
	 ...
	 *            elemento a agregar
	 * */
	public abstract boolean agregarFinal(Tipo elem);
	 ...
	 *            elemento a eliminar
	 * */
	public abstract boolean eliminar(Tipo elem);
	 ...
	 * */
	public abstract boolean incluye(Tipo elem);
