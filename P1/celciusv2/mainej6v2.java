...
public class mainej6v2 {
    public static void main(String[] args) {
        ...
        Scanner in= new Scanner(System.in); //abro el scanner y lo asocio a una variable
        double valor= in.nextDouble(); // le asigno a valor lo que lei en fn, y a eso lo convierto en double
